<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        <a class="navbar-brand" href="http://localhost:8000/admin">Start Bootstrap</a>
        ...
        <div class="navbar-collapse collapse show" id="navbarResponsive" style="">
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="" data-original-title="Charts">
                    <a class="nav-link" href="http://localhost:8000/admin/charts">
                        <i class="fa fa-fw fa-area-chart"></i>
                        <span class="nav-link-text">Charts</span>
                    </a>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="" data-original-title="Tables">
                    <a class="nav-link" href="http://localhost:8000/admin/tables">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="" data-original-title="Components">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseComponents">
                        <li>
                            <a href="http://localhost:8000/admin/navbar">Navbar</a>
                        </li>
                        <li>
                            <a href="http://localhost:8000/admin/cards">Cards</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="" data-original-title="Example Pages">
                    ...
                    <ul class="sidenav-second-level collapse" id="collapseExamplePages">
                        <li>
                            <a href="http://localhost:8000/admin/login">Login Page</a>
                        </li>
                        <li>
                            <a href="http://localhost:8000/admin/register">Registration Page</a>
                        </li>
                        <li>
                            <a href="http://localhost:8000/admin/forgot-password">Forgot Password Page</a>
                        </li>
                        <li>
                            <a href="http://localhost:8000/admin/blank">Blank Page</a>
                        </li>
                    </ul>
                </li>
