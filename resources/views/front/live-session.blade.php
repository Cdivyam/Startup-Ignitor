	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="pricing-item">
							<div class="media-wrapper">
									<img src="bingoimages/images/ment5.jpg" alt="amazing caves coverimage" class="img-responsive">
							</div>
							
						<div class="price-title text-center">
							<h3> Preparing for your First Meeting with Mentor</h3>
						</div>
						<br>
						<div class="center" style="text-align : center">
							<a class="btn btn-main" style:"position:absolute; top:50%" href="#">Watch</a>
						</div>
					</div>
				</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="pricing-item">
							<div class="media-wrapper">
									<img src="bingoimages/images/sess3.jpg" alt="amazing caves coverimage" class="img-responsive">
							</div>
							
						<div class="price-title text-center">
							<h3> Postive Business Conference Session</h3>
						</div>
			...
			<div class="col-md-4 col-sm-6 col-xs-12">
					<div class="pricing-item">
							<div class="media-wrapper">
									<img src="bingoimages/images/sess2.jpg" alt="amazing caves coverimage" class="img-responsive">
							</div>
							
						<div class="price-title text-center">
							<h3>QnA with John Doe</h3>
						</div>
						<br>
						<div class="center" style="text-align : center">
							<a class="btn btn-main" style:"position:absolute; top:50%" href="#">Watch</a>
