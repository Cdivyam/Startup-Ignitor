		...
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<div class="pro-block text-center" style="padding: 20px 50px; background: white; box-shadow: 0px 2px 28px 0px #7777775e; border-radius: 5px;">
					<h2 style="font-size: 50px; line-height: 1;">SCHEMES</h2>
					<h4 style="padding: 10px 0 15px 0;">We provide different schemes for the StartUps spread in vast varities<br>Our motto is to provide schemes and services for everyone</h4>
					<h4>Why Premium?</h4>
